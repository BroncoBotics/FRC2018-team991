    ...
    public StraightSwitch() {
    	...
    	if(gameData != null) {
    		if(gameData.charAt(0) == 'R'){
    			addSequential(new DriveStraight(0.65,0.8));
    			
    			addSequential(new WaitCommand(5));
    		} else if(gameData.charAt(0) == 'L'){
    			addSequential(new DriveStraight(0.65,0.6));
    			addSequential(new gyroTurn(0.55,75));
    			addSequential(new DriveStraight(0.65,2.0));
    			addSequential(new gyroTurn(0.55,-85));
    			addSequential(new DriveStraight(0.65,0.4));
